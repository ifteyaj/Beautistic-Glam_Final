      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-stone-600 leading-relaxed text-lg mb-6">
            Beautistic Glam was founded with a passion for clean, effective beauty. We started as a small boutique brand dedicated to creating products that truly work. Over the years, we've grown to serve customers worldwide who share our belief in the power of quality ingredients and ethical beauty.
          </p>
        </div>
      </section>
